...
Mage::app();
		...
		$url_path=$categorymagentoattributes['url_path']->getFrontend()->getValue($category);
		$url_key=$categorymagentoattributes['url_key']->getFrontend()->getValue($category);
		/*echo $name."====";
		echo $name_lin."====";
		echo $ott_id."====";
		echo $url_path."====";
		echo $url_key."====";
		*/
		$new_url=str2url($name);
		
		echo "===".$new_url."===";
		
		
		
		$general['url_key'] = $new_url;
