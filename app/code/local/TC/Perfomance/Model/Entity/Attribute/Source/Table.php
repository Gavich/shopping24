 ...
 */
/**
 * Rewrite base class add methods
 */
class TC_Perfomance_Model_Entity_Attribute_Source_Table extends Mage_Eav_Model_Entity_Attribute_Source_Table
{
    /**
     * Retrieve only needed options by IDs
     *
     * @param array $ids
     * @return mixed
     */
