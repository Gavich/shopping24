...
class TC_Import_Model_Import{
	...
	public static function getConnectionConfig(){
		$config = array(
			'host' => Mage::getStoreConfig(self::XML_PATH_PREFIX . 'host'),
			'username' => Mage::getStoreConfig(self::XML_PATH_PREFIX . 'user'),
			'password' => Mage::getStoreConfig(self::XML_PATH_PREFIX . 'password'),
			'dbname' => Mage::getStoreConfig(self::XML_PATH_PREFIX . 'name'),
